    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Almacén</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('/escritorioalmacen/producto/index')}}"><i class="fa fa-circle-o"></i> Artículos</a></li>
                <li><a href="{{url('/escritorioalmacen/categoria/index')}}"><i class="fa fa-circle-o"></i> Categorías</a></li>
              </ul>
            </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2020 <a href="">Franco Montti</a>.</strong> All rights reserved.
      </footer>
